...
mod build_bundled {
    ...
    pub fn main(out_dir: &str, out_path: &Path) {
        ...
        cfg.file(format!("{lib_name}/sqlite3.c"))
            .flag("-DSQLITE_CORE")
            // The vendored amalgamation is SQLite3MultipleCiphers 2.5.1.
            // Select the wxSQLite3-compatible AES-128-CBC cipher by default;
            // callers still configure the connection explicitly before keying.
            .flag("-DCODEC_TYPE=CODEC_TYPE_AES128")
