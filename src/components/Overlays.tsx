...
export function ExportDialog({ scope, format, dataRedaction, simplify, pretty, onSimplifyChange, onPrettyChange, messageCount, mediaCount, onScopeChange, onFormatChange, onDataRedactionChange, onClose, onConfirm }: { scope: ExportScope; format: ExportFormat; dataRedaction: boolean; simplify: boolean; pretty: boolean; onSimplifyChange: (enabled: boolean) => void; onPrettyChange: (enabled: boolean) => void; messageCount: number; mediaCount: number; onScopeChange: (scope: ExportScope) => void; onFormatChange: (format: ExportFormat) => void; onDataRedactionChange: (enabled: boolean) => void; onClose: () => void; onConfirm: () => Promise<void> }) {
